...
int main() {
	...
	float vertices[] = {
		-0.5f, -0.5f, 0.5f, //Para generar los vérticas ahora no estamos agregando el color sino unicamente la posicion
		0.5f, -0.5f, 0.5f,
		0.5f,  0.5f, 0.5f,
		0.5f,  0.5f, 0.5f,
		-0.5f,  0.5f, 0.5f,
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// modelTemp ayuda a asemejar donde se encuentra la articulación
		...
		//Antebrazo
		model = glm::translate(modelTemp, glm::vec3(1.5f, 0.0f, 0.0f));//Recorrer otros 1.5 unidades valor restante de la caga anterior
		...
		//Dedo 1 medio
		model = glm::translate(modelTemp, glm::vec3(0.25f, 0.0f, -0.25f));
		...
		model = glm::rotate(model, glm::radians(fl1), glm::vec3(0.0f, 1.0f, 0.0f));
		...
		// Dedo 2 falange 2
		model = glm::translate(modelTemp, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(fl2), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.25f, 0.25f));
		color = glm::vec3(1.0f, 0.5f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		model = glm::translate(modelTemp, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(fl3), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.25f, 0.25f));
		color = glm::vec3(1.0f, 0.5f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
